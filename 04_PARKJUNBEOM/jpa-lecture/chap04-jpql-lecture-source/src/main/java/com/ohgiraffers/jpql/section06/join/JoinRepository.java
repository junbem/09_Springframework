...
public class JoinRepository {
    ...
    public List<Menu> selectByFetchJoin(){
        // fetch: JPQL에서 성능 최적화를 위해 사용하는 기능으로 연관 엔터티나 컬렉션을 한번에 조회한다.
    ...
    public List<Object[]> selectByOuterJoin() {
        ...
        return entityManager.createQuery(jqpl, Object[].class).getResultList();
    }

    public List<Object[]> selectByCollectionJoin() {
        String jqpl = "SELECT c.categoryName, m.menuName FROM Section06Category c LEFT JOIN c.menuList m";
        return entityManager.createQuery(jqpl, Object[].class).getResultList();
    }
