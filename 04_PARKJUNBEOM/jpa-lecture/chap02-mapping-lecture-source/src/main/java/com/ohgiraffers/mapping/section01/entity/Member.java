...
//    @GeneratedValue(strategy = GenerationType.IDENTITY)
    ...
    @Access(AccessType.FIELD) // 필드 레벻에 작성 시 해당 필드에 대한 접근 방식 설정
    ...
    @Column(name="status", columnDefinition = "char(2) default 'Y'")
    ...
    @Access(AccessType.PROPERTY) // 해당 값의 접근 방식을 getter 메소드로 변경
